        ...
        created() {
            ...
            this.$http.get(`/${this.resource}/tables`)
                .then(response => {
                    ...
                    this.all_clients = response.data.clients
        ...
        methods: {
            ...
            filterClients() {
                if(this.form.document_type_id === '01') {
                    this.clients = _.filter(this.all_clients, {'identity_document_type_id': '6'})
                    this.selectClient()

                } else {
                    this.clients = _.filter(this.all_clients, (c) => { return c.identity_document_type_id !== '6' })
                    this.selectClient()
                }
            },
            selectClient(){
